...
if __name__ == "__main__":
    ...
    parser.add_argument("--gene_1", nargs="+",
                        default=['Mki67'],  help="write  the different name of a same probe ex Cap' aCap CEC acap")

    parser.add_argument("--gene_2", nargs="+",
    ...
    parser.add_argument("--path_to_save_excel", type=str,
                        default="/media/tom/Transcend/image_lustra0605/exelstwoprobes/",
    ...
    generate_exels_cell_state_type(list_folder = args.list_folder,
                                   gene_1 = args.gene_1,
                                   gene_2 = args.gene_2,
